...
public class AccountTransactionController {
    ...
    public final CreateAccountTransactionFlow createAccountTransactionFlow;
    public final FetchAccountTransactionFlow fetchAccountTransactionFlow;
    ...
    @ApiOperation(value = "Fetches the specified AccountTransaction.", notes = "Fetched the AccountTransaction corresponding to the given transactionId")
    @ApiResponses(value = {
